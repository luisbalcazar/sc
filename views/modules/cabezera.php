...
<?php 
    if ($_GET["action"]!="search" || strpos($_GET["action"], "_")) {
        $extracto = explode("_", $_GET["action"]);
        if ($extracto[0]!="reserve") {
...
<header id="header" class="transparent-header sticky-header second" data-sticky-class="not-dark" data-responsive-class="not-dark">
    <div id="header-wrap">
        <div class="container clearfix">
            <div id="primary-menu-trigger"><i class="icon-reorder"></i></div>

            <div class="wow swing" id="logo" data-wow-duration="1s">
                <a href="index" class="standard-logo" data-dark-logo="views/demos/travel/images/Logos/SicarlRental.png" ><img src="views/demos/travel/images/Logos/SicarlRental.png" alt="Sicar Rental" ></a>
            ...
            <nav id="primary-menu" class="style-4">
                <ul>
                    <li <?php if($_GET["action"]=="index"){echo "class='current'";} ?>>
                        <a href="index"><div><i class="icon-home2 round1"></i>Home</div></a> 
                    </li>
                    <li <?php if($_GET["action"]=="modelos"){echo "class='current'";} ?>>
                        <a href="modelos"><div><i class="fas fa-car round1" style="vertical-align: middle;"></i>Models</div></a>
                    </li>
                    <li <?php if($_GET["action"]=="servicios"){echo "class='current'";} ?>>
                        <a href="servicios"><div><i class="icon-building round1"></i>Rental Services</div></a>
                    </li>
                    <li <?php if($_GET["action"]=="blog"){echo "class='current'";} ?>>
                        <a href="blog"><div><i class="icon-pencil2 round1"></i>Blog</div></a>
                    </li>
                    <li>
                        <a href="tel:+91.11.85412542"><div><i class="icon-phone3 round1"></i>(786) 365-4846</div></a>
                    </li>
                </ul>
            </nav>
        </div>
