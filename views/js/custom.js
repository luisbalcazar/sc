$(document).ready(function() {
    ...
    var userFeed = new Instafeed({
        ...
        accessToken: '2065358650.1677ed0.3ee2b9b9acd54a1b96f62462a1037735',
        sortBy: 'most-recent',
        template: '<article class="portfolio-item pf-uielements pf-icons"><div class="portfolio-image"><a style="margin-bottom: -22px;" href="{{link}}" target="_blank"><img src="{{image}}" alt="{{caption}}" /><br></a></div></article>',
    });
...
$(".tabs").on("mouseleave", function(){
    $(".slide").css("filter", "none");
});


/*$(".icon-home2").on("click", function(){
    $(".clase1").addClass("round1");
});

$(".clase1").on("mouseout", function(){
    $(".clase1").removeClass("round1");
});
    ...
    slider.noUiSlider.on('change', function(values, handle) {
      ...
      ajax.ejecutar()
        .then((data)=>{
          ...
          var array = eval(data);
          if (array[0]=="") {
            $('#container-sections').html("<h2>Ops! Models not found.</h2>")
          }else{
          ...
          console.log("fallo filtro de precio");
          console.log(fail);
        });
