...
class GestorModelosModel{
	...
	public function guardarModeloModel($datosModel, $tabla){
		...
		//var_dump($datosModel);
		$stmt = Conexion::conectar()->prepare("INSERT INTO `modelos` (`idmodelo`, `idmarca`, `idmodelos_categorias`, `modelo`, `hora`, `dia`, `semana`, `mes`, `puestos`, `maleta`, `tanque`, `automatico`, `aire`, `unidades`, `estado`, `etiquetas`, `ruta`, `refueling`, `localcharge`, `llantas_impuesto`, `surcharge`, `licensefee`) VALUES (:idmodelo, :idmarca, :idmodelos_categorias, :modelo, :hora, :dia, :semana, :mes, :puestos, :maleta, :tanque, :automatico, :aire, :unidades, :estado, :etiquetas, :ruta, :refueling, :localcharge, :llantas_impuesto , :surcharge, :licensefee )");
	...
	#MOSTRAR ARTÍCULOS
	#------------------------------------------------------
	public static function mostrarModelosModel($tabla){
	...
	#MOSTRAR ARTÍCULOS
	#------------------------------------------------------
	public static function llenarModelosModel($tabla, $id){
...
#MOSTRAR mostrarModelosCategorias en select
	#------------------------------------------------------
	public static function mostrarModelosCategorias($tabla){
...
#MOSTRAR Marcas en select
	#------------------------------------------------------
	public static function mostrarMarca($tabla){
	...
	#BORRAR ARTICULOS
	#-----------------------------------------------------
	public static function borrarModeloModel($datosModel, $tabla){
